...
class jeeb extends base
{
  ...
  function after_process()
  {
    ...
    $amount = \Jeeb\Merchant\Order::convertBaseToTarget($baseUri, $order->info['total'], $signature, $baseCur);
